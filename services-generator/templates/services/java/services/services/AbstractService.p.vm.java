...
$output.require("net.leidra.pm.core.repositories.GenericRepository")##
$output.require("${configuration.rootPackage}.shared.dtos.AbstractDto")##
...
public abstract class $output.currentClass<ENTITY, DTO extends AbstractDto> implements Service<DTO> {
    @Autowired
    protected final GenericRepository<ENTITY> repository;
    protected static final MapperFactory mapperFactory = new DefaultMapperFactory.Builder().useBuiltinConverters(true).build();
